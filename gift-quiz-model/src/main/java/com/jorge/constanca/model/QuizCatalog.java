...
public final class QuizCatalog {
    ...
    private static final List<QuizQuestion> ROMANTIC_GIFT_QUIZ = List.of(
            new QuizQuestion(
                    "bag-surprise",
    ...
    public static List<QuizQuestion> romanticGiftQuiz() {
        return ROMANTIC_GIFT_QUIZ;
    }

    public static String optionLabelFor(String optionId) {
        for (QuizQuestion question : ROMANTIC_GIFT_QUIZ) {
    ...
    public static String questionPromptFor(String questionId) {
        for (QuizQuestion question : ROMANTIC_GIFT_QUIZ) {
